...
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets design_1_i/clk_wiz_0/inst/clkfbout_design_1_clk_wiz_0_2]
#set_property CLOCK_DEDICATED_ROUTE BACKBONE [get_nets design_1_i/video_ss/dvi2rgb_0/U0/TMDS_ClockingX/CLK_IN_hdmi_clk]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets design_1_i/clk_wiz_0/inst/clk_out1_design_1_clk_wiz_0_2]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets design_1_i/video_ss/dvi2rgb_0/U0/TMDS_ClockingX/CLK_OUT_5x_hdmi_clk]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets design_1_i/clk_wiz_0/inst/clkfbout_design_1_clk_wiz_0_0]
...
#set_property -dict { PACKAGE_PIN G4  IOSTANDARD LVCMOS33 } [get_ports { reset_rtl_0 }]; #IO_L12N_T1_MRCC_35 Sch=cpu_resetn


## Switches
set_property -dict { PACKAGE_PIN E22  IOSTANDARD LVCMOS33 } [get_ports { switch_input[0] }]; #IO_L22P_T3_16 Sch=sw[0]
set_property -dict { PACKAGE_PIN F21  IOSTANDARD LVCMOS33 } [get_ports { switch_input[1] }]; #IO_25_16 Sch=sw[1]
set_property -dict { PACKAGE_PIN G21  IOSTANDARD LVCMOS33 } [get_ports { switch_input[2] }]; #IO_L24P_T3_16 Sch=sw[2]
set_property -dict { PACKAGE_PIN G22  IOSTANDARD LVCMOS33 } [get_ports { switch_input[3] }]; #IO_L24N_T3_16 Sch=sw[3]
set_property -dict { PACKAGE_PIN H17  IOSTANDARD LVCMOS33 } [get_ports { switch_input[4] }]; #IO_L6P_T0_15 Sch=sw[4]
set_property -dict { PACKAGE_PIN J16  IOSTANDARD LVCMOS33 } [get_ports { switch_input[5] }]; #IO_0_15 Sch=sw[5]
set_property -dict { PACKAGE_PIN K13  IOSTANDARD LVCMOS33 } [get_ports { switch_input[6] }]; #IO_L19P_T3_A22_15 Sch=sw[6]
set_property -dict { PACKAGE_PIN M17  IOSTANDARD LVCMOS33 } [get_ports { switch_input[7] }]; #IO_25_15 Sch=sw[7]
...
set_property -dict { PACKAGE_PIN AB12  IOSTANDARD LVCMOS25 } [get_ports { hdmi_in_hpd }]; #IO_L7N_T1_13 Sch=hdmi_rx_hpa
...
## Pmod header JA: Servo motor controller on bottom row, RangeFinder on Top Row
#set_property -dict { PACKAGE_PIN AB22  IOSTANDARD LVCMOS33 } [get_ports { ja[1] }]; #IO_L10N_T1_D15_14 Sch=ja[1]
set_property -dict { PACKAGE_PIN AB21  IOSTANDARD LVCMOS33 } [get_ports { rangefinder_uart_txd }]; #IO_L10P_T1_D14_14 Sch=ja[2]
set_property -dict { PACKAGE_PIN AB20  IOSTANDARD LVCMOS33 } [get_ports { rangefinder_uart_rxd }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=ja[3]
...
set_property -dict { PACKAGE_PIN AA18  IOSTANDARD LVCMOS33 } [get_ports { servo_pwm_1 }]; #IO_L17P_T2_A14_D30_14 Sch=ja[10]


## Pmod header JB: Power Monitor Module
...
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33 PULLUP TRUE} [get_ports { power_monitor_iic_scl_io }]; #IO_L19P_T3_34 Sch=jb_p[2]
set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 PULLUP TRUE} [get_ports { power_monitor_iic_sda_io }]; #IO_L19N_T3_VREF_34 Sch=jb_n[2]
#set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 PULLUP TRUE} [get_ports { power_monitor_iic_sda_io }]; #IO_L24P_T3_34 Sch=jb_p[3]
...
## Pmod header JC: Hbridge controller
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33 } [get_ports { h_bridge_dir_gpio }]; #IO_L18P_T2_34 Sch=jc_p[1]
set_property -dict { PACKAGE_PIN AA6   IOSTANDARD LVCMOS33 } [get_ports { h_bridge_pwm }]; #IO_L18N_T2_34 Sch=jc_n[1]
...
## XADC Header
set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { Vaux1_0_v_p }]; #IO_L3P_T0_DQS_AD1P_15 Sch=xa_p[1]
set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { Vaux1_0_v_n }]; #IO_L3N_T0_DQS_AD1N_15 Sch=xa_n[1]
set_property -dict { PACKAGE_PIN H13   IOSTANDARD LVCMOS33 } [get_ports { Vaux0_0_v_p }]; #IO_L1P_T0_AD0P_15 Sch=xa_p[2]
set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { Vaux0_0_v_n }]; #IO_L1N_T0_AD0N_15 Sch=xa_n[2]
...
## UART
#set_property -dict { PACKAGE_PIN AA19  IOSTANDARD LVCMOS33 } [get_ports { usb_uart_rxd }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=uart_rx_out
#set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { usb_uart_txd }]; #IO_L14P_T2_SRCC_14 Sch=uart_tx_in
